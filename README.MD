...
## 19 February
  * removed another couple of bugs in the investment algorithm. Project 1 now runs from start to finish of a cycle, and ends up in the same state - which is what should in fact happen
