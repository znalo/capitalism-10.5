...
class TimeStamp(models.Model):
    ...
    # super_state_FK = models.ForeignKey(ControlSuperState, max_length=20, on_delete=models.CASCADE)
    # sub_state_FK = models.ForeignKey(ControlSubState, max_length=20, on_delete=models.CASCADE)
