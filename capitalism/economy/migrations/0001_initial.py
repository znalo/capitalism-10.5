# Generated by Django 3.2.9 on 2022-02-21 09:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project_number', models.SmallIntegerField(default=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('commodity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='economy_stockowner_related', to='economy.commodity')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('simulation', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='economy.simulation')),
            ],
        ),
        migrations.CreateModel(
            name='TimeStamp',
            fields=[
                ...
                ('melt', models.FloatField(default=1)),
                ('total_value', models.FloatField(default=-1)),
                ('total_price', models.FloatField(default=-1)),
                ('initial_capital', models.FloatField(default=-1)),
                ('current_capital', models.FloatField(default=1)),
                ('profit', models.FloatField(default=-1)),
                ('profit_rate', models.FloatField(default=-1)),
                ('simulation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='economy.simulation')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('commodity', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='economy.commodity')),
                ('simulation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='economy.simulation')),
                ('stock_owner', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='economy.stockowner')),
                ('time_stamp', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='economy_stock_related', to='economy.timestamp')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='simulation',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='economy.simulation'),
        ),
        migrations.AddField(
            model_name='commodity',
            name='time_stamp',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('social_class', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='class_stock', to='economy.socialclass')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('industry', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='economy.industry')),
            ],
            options={
